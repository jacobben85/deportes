...
import com.univision.videos.mcp.XMLHelper;
...
public class PostToLocal {
    ...
    private static String url = "http://local.cms.uvn.io/passthrough/f13";

    public static void postToServer(boolean mcpId) throws IOException {
        xmlPath = System.getProperty("user.dir") + "/xml/feed/f13.xml";
        postToServer();
    }
